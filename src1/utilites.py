...
# abspath(__file__) -> C:\dev\SeleniumProject\src\utilities.py
# dirname(abspath(__file__)) -> C:\dev\SeleniumProject\src\
ROOT_DIR = dirname(dirname(abspath(__file__)))  # C:\dev\SeleniumProject\
